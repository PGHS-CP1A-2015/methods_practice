...
namespace TestCP1_P4
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.AreEqual(12.56, P4_2.MyMathFunctions.circumferenceOfCircle(2));
            Assert.AreEqual(75.36, P4_2.MyMathFunctions.circumferenceOfCircle(12));
            Assert.AreEqual(34.54, P4_2.MyMathFunctions.circumferenceOfCircle(5.5));
            Assert.AreEqual(43.96, P4_2.MyMathFunctions.circumferenceOfCircle(7));
        }
        ...
        public void Test_calculate_area_of_a_circle()
        {
            ...
            Assert.AreEqual(12.56, P4_2.MyMathFunctions.areaOfCircle(2));
            Assert.AreEqual(314, P4_2.MyMathFunctions.areaOfCircle(10));
            Assert.AreEqual(94.985, P4_2.MyMathFunctions.areaOfCircle(5.5));
            Assert.AreEqual(153.86, P4_2.MyMathFunctions.areaOfCircle(7));
        }
        [TestMethod]
